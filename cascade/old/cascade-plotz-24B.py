...
data_dir = '/Users/peter/Public/data/20240604-163805/'

data_dir = '/Users/peter/Public/data/20240611-162559/'
...
#	dpt = np.array([0.0001, 0.15, 0.30, 0.50]) # trigger cascade (set by hardware)
