...
# run 24C https://docs.google.com/spreadsheets/d/1WIpSKpMFkJUkkcpzwHysUUQtj0LmbtK8/edit#gid=1505682760
# 	data_dir = '/Users/peter/Public/data/20240319-150343/' # after open to air, 0.5,1.0,5.0 ms
# run 24D https://docs.google.com/spreadsheets/d/1gEBQH5_i2pRtjLR8kTf59hhimMYA22ew/edit#gid=520589302
# 	data_dir = '/Users/peter/Public/data/20240411-095815/' # after 100C bake overnight 150,300,500 us
# 	data_dir = '/Users/peter/Public/data/20240411-103253/' # after 100C bake overnight 0.5,1.0,5.0 ms
# run 24F https://docs.google.com/spreadsheets/d/15aACFgdQ0L_mwpsHHUAktRluckgiX3OP/edit#gid=1657028746
	data_dir = '/Users/peter/Public/data/20240529-165141/' # cascade data, 0.5,1.0,5.0 ms
# 	data_dir = '/Users/peter/Public/data/20240529-171140/' # LED, cascade data, 0.5,1.0,5.0 ms
# 	data_dir = '/Users/peter/Public/data/20240529-174148/' # LED more power, cascade data, 0.5,1.0,5.0 ms

# LED triggers 490 nm
# 	data_dir = '/Users/peter/Public/data/20240604-155311/'
# 	data_dir = '/Users/peter/Public/data/20240604-160408/'
	data_dir = '/Users/peter/Public/data/20240604-161910/'
...
# LED triggers 235 nm
#	data_dir = '/Users/peter/Public/data/20240611-161143/' # random LED cascade, 2 us wide pulse, 
	data_dir = '/Users/peter/Public/data/20240611-162559/' # 133Ba cascade
	data_dir = '/Users/peter/Public/data/20240611-163924/' # 133Ba cascade + LED
...
# 			aa[i,n+2] = np.sum(y2z[y2z>s8]) * 2 / spe_sizes[i] # factor x2 for 2 ns samples
		...
		if 0: #(np.sum(y0s)<2e5): # S1-only catcher
			pl.figure(7);pl.clf()
			pl.subplot(1,2,1)
		...
		if 1:#(np.sum(y0s)<2e5): # S1-only catcher # graphics
...
# 	aa_file = compressed_file[0:-29]+"aa_"+("%02d"%ff)+".npz"		
	...
	np.savez(aa_file,aa,ee,s1,is1,is2,s2f,eec,ss)
	ff = ff + 1
