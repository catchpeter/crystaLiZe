...
def transfer():
    ...
    for dir in all_dir:
        ...
        m = dir[17:28]
        d = dir[29:38]
        create_month = "ssh xaber@theo.dhcp.lbl.gov mkdir -p /media/xaber/G-Drive2/crystalize_data/"+m
        os.system(create_month)
        create_day = "ssh xaber@theo.dhcp.lbl.gov mkdir -p /media/xaber/G-Drive2/crystalize_data/"+m+"/"+d
        ...
        # Transfer data
        m_and_d = dir[17:38]
        remote_dir = "/media/xaber/G-Drive2/crystalize_data/" + m_and_d
        ...
        transfer_flag_command = "scp -r " + dir + "transferDone" + " xaber@theo.dhcp.lbl.gov:/media/xaber/G-Drive2/crystalize_data/" + dir[17:]
